"""Retail domain data models. Ported from tau2-bench with tau2 imports removed."""
...
class RetailDB(BaseModel):
    ...
    def get_hash(self) -> str:
        """Get a SHA-256 hash of the database state."""
        hash_string = json.dumps(self.model_dump(), sort_keys=True, default=str)
